...
namespace PlanX.Services.News
{
    public partial class CategoryNewsService : ICategoryNewsService
    {
        ...
        private const string CATEGORIES_ALL = "planx.newscategory.All-{0}";
        private const string CATEGORIES_BY_ID_KEY = "planx.newscategory.id-{0}";
        private const string CATEGORIES_BY_PARENT_CATEGORY_ID_KEY = "planx.newscategory.byparent-{0}-{1}";
        private const string NEWSCATEGORIES_ALLBYCATEGORYID_KEY = "planx.newscategorymap.allbycategoryid-{0}-{1}-{2}-{3}";
        private const string NEWSCATEGORIES_ALLBYNEWSID_KEY = "planx.newscategorymap.allbynewsid-{0}-{1}";
        private const string NEWSCATEGORIES_BY_ID_KEY = "planx.newscategorymap.id-{0}";
        private const string CATEGORIES_PATTERN_KEY = "planx.categorynews.";
        private const string NEWSCATEGORIES_PATTERN_KEY = "plax.newscategorymap.";
        ...
        public virtual async Task<IList<CategoryNews>> GetAllCategoriesAsync(string categoryName, bool showHidden = false)
        {
            ...
            {
                return GetAllCategories(categoryName, showHidden);
            });
        }
        /// <summary>
        /// Gets all categories
        ...
        public virtual async Task<IPagedList<NewsCategoryNews>> GetNewsCategoriesByCategoryIdAsync(int categoryId, int pageIndex, int pageSize, bool showHidden = false)
        {
            ...
            {
                return GetNewsCategoriesByCategoryId(categoryId, pageIndex, pageSize, showHidden);
            });
        }
        ...
        public virtual async Task<NewsCategoryNews> GetNewsCategoryByIdAsync(int newsCategoryId)
        {
            ...
            {
                return GetNewsCategoryById(newsCategoryId);
            });
        }
        /// <summary>
