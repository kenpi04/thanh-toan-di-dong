...
namespace PlanX.Services.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        /// </remarks>
        private const string COUNTRIES_ALL_KEY = "PlanX.country.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : show hidden records?
        /// </remarks>
        private const string COUNTRIES_BILLING_KEY = "PlanX.country.billing-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : show hidden records?
        /// </remarks>
        private const string COUNTRIES_SHIPPING_KEY = "PlanX.country.shipping-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string COUNTRIES_PATTERN_KEY = "PlanX.country.";
