...
namespace PlanX.Services.Stores
{
    ...
    public partial class StoreMappingService : IStoreMappingService
    {
        ...
        /// {1} : entity name
        /// </remarks>
        private const string STOREMAPPING_BY_ENTITYID_NAME_KEY = "PlanX.storemapping.entityid-name-{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STOREMAPPING_PATTERN_KEY = "PlanX.storemapping.";
