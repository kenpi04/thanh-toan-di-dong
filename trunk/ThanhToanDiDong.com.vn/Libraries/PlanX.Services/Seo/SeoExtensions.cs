...
namespace PlanX.Services.Seo
{
    public static class SeoExtensions
    {
        ...
        /// <summary>
        /// Gets tag SE (search engine) name
        /// </summary>
        /// <param name="tag">tag</param>
        /// <returns>newstag SE (search engine) name</returns>
        public static string GetSeName(this Tag  tag)
        {
            var workContext = EngineContext.Current.Resolve<IWorkContext>();
            return GetSeName(tag.EnglishName);
        }       
