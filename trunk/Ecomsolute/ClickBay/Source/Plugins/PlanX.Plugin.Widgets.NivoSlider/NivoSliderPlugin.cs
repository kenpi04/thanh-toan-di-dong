...
namespace PlanX.Plugin.Widgets.NivoSlider
{
    /// <summary>
    /// PLugin
    /// </summary>
    public class NivoSliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "PlanX.Plugin.Widgets.NivoSlider.Controllers" }, { "area", null } };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            {
                {"Namespaces", "PlanX.Plugin.Widgets.NivoSlider.Controllers"},
                {"area", null},
