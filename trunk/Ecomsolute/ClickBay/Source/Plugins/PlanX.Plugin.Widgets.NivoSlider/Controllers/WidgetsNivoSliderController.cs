...
using PlanX.Plugin.Widgets.NivoSlider.Infrastructure.Cache;
using PlanX.Plugin.Widgets.NivoSlider.Models;
...
namespace PlanX.Plugin.Widgets.NivoSlider.Controllers
{
    public class WidgetsNivoSliderController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("PlanX.Plugin.Widgets.NivoSlider.Views.WidgetsNivoSlider.Configure", model);
        }
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            return View("PlanX.Plugin.Widgets.NivoSlider.Views.WidgetsNivoSlider.PublicInfo", model);
        }
    }
}