...
using PlanX.Plugin.Widgets.GoogleAnalytics.Models;
...
namespace PlanX.Plugin.Widgets.GoogleAnalytics.Controllers
{
    public class WidgetsGoogleAnalyticsController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("PlanX.Plugin.Widgets.GoogleAnalytics.Views.WidgetsGoogleAnalytics.Configure", model);
        }
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            //return View("PlanX.Plugin.Widgets.GoogleAnalytics.Views.WidgetsGoogleAnalytics.PublicInfo", model);
        }
