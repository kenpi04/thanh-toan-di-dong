...
namespace PlanX.Services.Logging
{
    /// <summary>
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "PlanX.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "PlanX.activitytype.";
