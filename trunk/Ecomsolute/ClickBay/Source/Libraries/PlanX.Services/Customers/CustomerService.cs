...
namespace PlanX.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        /// </remarks>
        private const string CUSTOMERROLES_ALL_KEY = "PlanX.customerrole.all-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : system name
        /// </remarks>
        private const string CUSTOMERROLES_BY_SYSTEMNAME_KEY = "PlanX.customerrole.systemname-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string CUSTOMERROLES_PATTERN_KEY = "PlanX.customerrole.";
