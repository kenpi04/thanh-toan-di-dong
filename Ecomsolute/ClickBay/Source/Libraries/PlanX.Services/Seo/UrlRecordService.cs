...
namespace PlanX.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        /// {2} : language ID
        /// </remarks>
        private const string URLRECORD_ACTIVE_BY_ID_NAME_LANGUAGE_KEY = "PlanX.urlrecord.active.id-name-language-{0}-{1}-{2}";
        /// <summary>
        /// Key for caching
        /// </summary>
        private const string URLRECORD_ALL_KEY = "PlanX.urlrecord.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string URLRECORD_PATTERN_KEY = "PlanX.urlrecord.";
