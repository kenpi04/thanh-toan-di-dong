...
namespace PlanX.Plugin.Widgets.GoogleAnalytics
{
    ...
    public class GoogleAnalyticPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "PlanX.Plugin.Widgets.GoogleAnalytics.Controllers" }, { "area", null } };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            {
                {"Namespaces", "PlanX.Plugin.Widgets.GoogleAnalytics.Controllers"},
                {"area", null},
