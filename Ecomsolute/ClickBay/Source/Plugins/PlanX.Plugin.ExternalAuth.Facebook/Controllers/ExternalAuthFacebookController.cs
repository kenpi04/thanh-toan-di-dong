...
using PlanX.Plugin.ExternalAuth.Facebook.Models;
...
namespace PlanX.Plugin.ExternalAuth.Facebook.Controllers
{
    public class ExternalAuthFacebookController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("PlanX.Plugin.ExternalAuth.Facebook.Views.ExternalAuthFacebook.Configure", model);
        }
        ...
        {
            return View("PlanX.Plugin.ExternalAuth.Facebook.Views.ExternalAuthFacebook.PublicInfo");
        }
