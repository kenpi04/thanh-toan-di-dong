...
namespace PlanX.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["planx.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["planx.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["planx.IsPOSTBeingDone"] = value;
            }
        }
    }
}
