...
namespace PlanX.Services.Localization
{
    ...
    public partial class LanguageService : ILanguageService
    {
        ...
        /// {0} : language ID
        /// </remarks>
        private const string LANGUAGES_BY_ID_KEY = "PlanX.language.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string LANGUAGES_ALL_KEY = "PlanX.language.all-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string LANGUAGES_PATTERN_KEY = "PlanX.language.";
