...
namespace PlanX.Services.Common
{
    public class BannerService : IBannerService
    {
        ...
        #region Constants
        private const string BANNERS_BY_ID_KEY = "planx.Banner.id-{0}";
        private const string BANNERS_PATTERN_KEY = "planx.Banner.";
        #endregion
        ...
        public virtual async Task<IList<Banner>> GetAllBannersAsync(int position = 0, int storeId = 0, bool showHidden = false)
        {
            ...
            {
                return GetAllBanners(position, storeId, showHidden);
            });
        }
        /// <summary>
        /// Gets a Banner
